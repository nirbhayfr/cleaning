...
export default function CheckoutPage() {
  ...
  const isPaymentValid =
    paymentMode === "cod" || (paymentMode === "online" && selectedOnlineOption);
    ...
    <div className="checkout-wrapper">
      ...
      <div className="checkout-section">
        ...
        <div className="payment-options">
          <label
            className={`pay-option ${paymentMode === "cod" ? "active" : ""}`}
          >
            <input
              type="radio"
              name="payment"
          ...
          <label
            className={`pay-option ${paymentMode === "online" ? "active" : ""}`}
          >
            <input
              type="radio"
              name="payment"
        ...
        {paymentMode === "online" && (
          <div className="online-pay-grid">
            {["phonepe", "gpay", "debit", "credit"].map((option) => (
              <div
                key={option}
                className={`online-pay-card ${
                  selectedOnlineOption === option ? "selected" : ""
                }`}
